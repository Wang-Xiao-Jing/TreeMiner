...
public class TreeMinerBlocks extends XiaoJinCreateBlock {
    ...
    public static final TreeMinerCreate LODE_SAPLING_COAL = new TreeMinerCreate("lode_sapling_coal", (properties) -> new LodeSaplingBlock(TreeMinerTreeGrower.LODE_COAL, properties, saplingProperties().growable(BlockTags.COAL_ORES)), createSaplingProperties(MapColor.PLANT, SoundType.STONE));
    public static final TreeMinerCreate LODE_SAPLING_IRON = new TreeMinerCreate("lode_sapling_iron", (properties) -> new LodeSaplingBlock(TreeMinerTreeGrower.LODE_IRON, properties, saplingProperties().growable(BlockTags.IRON_ORES)), createSaplingProperties(MapColor.STONE, SoundType.STONE));
    public static final TreeMinerCreate LODE_SAPLING_COPPER = new TreeMinerCreate("lode_sapling_copper", (properties) -> new LodeSaplingBlock(TreeMinerTreeGrower.LODE_COPPER, properties, saplingProperties().growable(BlockTags.COPPER_ORES)), createSaplingProperties(MapColor.STONE, SoundType.STONE));
    public static final TreeMinerCreate LODE_SAPLING_LAPIS = new TreeMinerCreate("lode_sapling_lapis", (properties) -> new LodeSaplingBlock(TreeMinerTreeGrower.LODE_LAPIS, properties, saplingProperties().growable(BlockTags.LAPIS_ORES)), createSaplingProperties(MapColor.STONE, SoundType.STONE));
    public static final TreeMinerCreate LODE_SAPLING_EMERALD = new TreeMinerCreate("lode_sapling_emerald", (properties) -> new LodeSaplingBlock(TreeMinerTreeGrower.LODE_EMERALD, properties, saplingProperties().growable(BlockTags.EMERALD_ORES)), createSaplingProperties(MapColor.STONE, SoundType.STONE));
    public static final TreeMinerCreate LODE_SAPLING_GOLD = new TreeMinerCreate("lode_sapling_gold", (properties) -> new LodeSaplingBlock(TreeMinerTreeGrower.LODE_GOLD, properties, saplingProperties().growable(Blocks.GOLD_ORE, Blocks.DEEPSLATE_GOLD_ORE)), createSaplingProperties(MapColor.STONE, SoundType.STONE));
    public static final TreeMinerCreate LODE_SAPLING_REDSTONE = new TreeMinerCreate("lode_sapling_redstone", (properties) -> new LodeSaplingBlock(TreeMinerTreeGrower.LODE_REDSTONE, properties, saplingProperties().growable(BlockTags.REDSTONE_ORES)), createSaplingProperties(MapColor.STONE, SoundType.STONE));
    public static final TreeMinerCreate LODE_SAPLING_DIAMOND = new TreeMinerCreate("lode_sapling_diamond", (properties) -> new LodeSaplingBlock(TreeMinerTreeGrower.LODE_DIAMOND, properties, saplingProperties().growable(BlockTags.DIAMOND_ORES)), createSaplingProperties(MapColor.STONE, SoundType.STONE));
    public static final TreeMinerCreate NETHER_LODE_SAPLING_GLOWSTONE = new TreeMinerCreate("nether_lode_sapling_glowstone", (properties) -> new LodeSaplingBlock(TreeMinerTreeGrower.NETHER_LODE_GLOWSTONE, properties, saplingProperties().growable(Blocks.GLOWSTONE)), createSaplingProperties(MapColor.NETHER, SoundType.NETHERRACK));
    public static final TreeMinerCreate NETHER_LODE_SAPLING_QUARTZ = new TreeMinerCreate("nether_lode_sapling_quartz", (properties) -> new LodeSaplingBlock(TreeMinerTreeGrower.NETHER_LODE_QUARTZ, properties, saplingProperties().growable(Blocks.NETHER_QUARTZ_ORE)), createSaplingProperties(MapColor.NETHER, SoundType.NETHERRACK));
    public static final TreeMinerCreate NETHER_LODE_SAPLING_GOLD = new TreeMinerCreate("nether_lode_sapling_gold", (properties) -> new LodeSaplingBlock(TreeMinerTreeGrower.NETHER_LODE_GOLD, properties, saplingProperties().growable(Blocks.NETHER_GOLD_ORE)), createSaplingProperties(MapColor.NETHER, SoundType.NETHERRACK));
    public static final TreeMinerCreate NETHER_LODE_SAPLING_ANCIENT_DEBRIS = new TreeMinerCreate("nether_lode_sapling_ancient_debris", (properties) -> new LodeSaplingBlock(TreeMinerTreeGrower.NETHER_LODE_ANCIENT_DEBRIS, properties, saplingProperties().growable(Blocks.ANCIENT_DEBRIS)), createSaplingProperties(MapColor.NETHER, SoundType.NETHERRACK), new Item.Properties().fireResistant());
