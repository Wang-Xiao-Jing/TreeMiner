...
public class TreeMinerBlocks extends XiaoJinCreateBlock {
    ...
    public static final TreeMinerBlockCreate NETHER_LODE_SAPLING_GLOWSTONE = new TreeMinerBlockCreate("nether_lode_sapling_glowstone", (it) -> new LodeSaplingBlock(TreeMinerTreeGrower.NETHER_LODE_GLOWSTONE, it, saplingProperties().placeable(Blocks.GLOWSTONE)), createSaplingProperties(MapColor.NETHER, SoundType.NETHERRACK).lightLevel(blockState -> 13));
